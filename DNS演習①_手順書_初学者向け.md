...
### Q4. SOAレコードを書いているのに、なぜNSレコードも書くのですか

### A4.
SOAレコードとNSレコードは、似て見えて**役割が違う**ためです。

- **SOAレコード**  
  → そのゾーンの基本情報を書くレコード
- **NSレコード**  
  → そのゾーンを担当するDNSサーバを書くレコード
...
### Q5. 今回はzoneファイルにプライベートIPを書いていますが、パブリックIPではだめですか
A5. だめではありません。  
...
### Q6. 何のために `named.conf` とzoneファイルは存在するのですか
A6. ひとことで言うと、  
